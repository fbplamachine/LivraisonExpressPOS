package com.israel.livraisonexpresspos.ui.inventory_management.returns;
...
import com.israel.livraisonexpresspos.databinding.FragmentReturnBinding;
...
public class ReturnFragment extends Fragment {
    private FragmentReturnBinding mBinding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        mBinding = DataBindingUtil.inflate(inflater, R.layout.fragment_return, container, false);
        initViewModel();
        initUi();
        stream();
    ...
    private void stream() {
        mViewModel.getIsReturnMovesLoading().observe(getViewLifecycleOwner(), isLoading -> {
            if (isLoading) {
        ...
        mViewModel.getReturnMoves().observe(getViewLifecycleOwner(), new Observer<List<Move>>() {
            @Override
